...
public class TormentaDeArena extends Clima {

    public TormentaDeArena(){
        super();
        this.nombreVisible = "Tormenta de Arena";
    }
    @Override
    ...
    public HashMap<Tipo, Tipo> tiposBeneficiados(){
        ...
        tiposBeneficiados.put(Tipo.Tierra, Tipo.Tierra);
        tiposBeneficiados.put(Tipo.Roca, Tipo.Roca);
        return tiposBeneficiados;
    }
    @Override
    public ClimaEnum getTipo() {
        return ClimaEnum.TormentaDeArena;
    }
}
